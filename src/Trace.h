...
struct Trace
{
    Trace(glm::vec2 const& initialPosition, float initialDirection_, std::chrono::steady_clock::time_point const& creationTime, std::shared_ptr<const GLuint> pProgram, std::shared_ptr<const GLuint> pBuffer);
